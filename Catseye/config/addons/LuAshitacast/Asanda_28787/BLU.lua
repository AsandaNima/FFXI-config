...
local sets = {
	...
	Tp_Default_Priority = {
		Head = { "Optical Hat", "Gambler's Chapeau", "Fungus Hat", "Cmp. Eye Circlet", "Eyepatch" },
		Neck = { "Peacock Charm", "Spike Necklace", "Armiger's Lace", "Pile Chain" },
		Ear1 = { "Pigeon Earring", "Optical Earring" },
		Ear2 = { "Pigeon Earring" },

		Body = { "Scorpion Harness", "Garrison Tunica +1", "Solid Mail", "Leather Vest", "Mithran Separates" },
		Hands = { "Battle Gloves", "Mithran Gauntlets" },
		Ring1 = { "Sniper's Ring", "Archer's Ring", "Bastokan Ring" },
		Ring2 = { "Sniper's Ring", "Archer's Ring", "San d'Orian Ring" },

		Back = { "Nomad's Mantle", "Mist Silk Cape", "Shaper's Shawl" },
		Waist = { "Swift Belt", "Tilt Belt", "Lizard Belt", "Leather Belt" },
		Legs = { "Dino Trousers", "Garish Slacks", "Garrison Hose +1", "Phl. Trousers", "Solid Cuisses", "Mithran Loincloth" },
	...
	Precast_Priority = { --64
		Head = { "Optical Hat", "Heroic Hairpin", "Fungus Hat", "Entrancing Ribbon" },
		Waist = { "Swift Belt" },
		Legs = { "Magus Shalwar", "White Slacks", "Garrison Hose +1" },
		Feet = { "Dino Ledelsens" },
	},
	Blu_Precast = {
	},
	...
	Ws_Default_Priority = {
		Head = { "Dino Helm", "Gambler's Chapeau", "Fungus Hat", "Cmp. Eye Circlet", "Eyepatch" },
		Neck = { "Peacock Charm", "Spike Necklace", "Armiger's Lace", "Pile Chain" },
		Ear1 = { "Pigeon Earring", "Optical Earring" },
		Ear2 = { "Pigeon Earring" },

		Body = { "Brigandine +1", "Garrison Tunica +1", "Solid Mail", "Leather Vest", "Mithran Separates" },
		Hands = { "Raptor Gloves", "Battle Gloves", "Mithran Gauntlets" },
		Ring1 = { "Sniper's Ring", "Archer's Ring", "Bastokan Ring" },
		Ring2 = { "Sniper's Ring", "Archer's Ring", "San d'Orian Ring" },

		Back = { "Nomad's Mantle", "Mist Silk Cape", "Shaper's Shawl" },
		Waist = { "Tilt Belt", "Lizard Belt", "Leather Belt" },
		Legs = { "Dino Trousers", "Garish Slacks", "Garrison Hose +1", "Phl. Trousers", "Solid Cuisses", "Mithran Loincloth" },
		Feet = { "Dino Ledelsens", "Leaping Boots", "Mithran Gaiters" },
	},
	Ws_Hybrid = {
