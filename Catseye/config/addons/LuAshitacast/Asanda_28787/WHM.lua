...
local sets = {
	...
	["upgrade"] = {
		Main = {
			Name = "Pilgrim's Wand",
			Augment = { [1] = '"Conserve MP"+2', [2] = "MP+5", [3] = "MP recovered while healing +1" },
		},
		Sub = { Name = "Pelte", Augment = { [1] = "MP recovered while healing +2", [2] = "MND+1", [3] = "INT+1" } },
		Head = {
			Name = "Entrancing Ribbon",
			Augment = { [1] = "Pet: Rng. Acc.+2", [2] = '"Fast Cast"+1', [3] = "Pet: Accuracy+2" },
		},
		Neck = "Justice Badge",
		...
		Back = {
			Name = "Mist Silk Cape",
			Augment = { [1] = '"Cure" spellcasting time -1%', [2] = '"Cure" potency +1%' },
		},
