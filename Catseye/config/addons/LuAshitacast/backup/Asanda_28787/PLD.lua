...
local fastCastValue = 0.0 -- 0% from gear
...
--[[        Main = "Apollo's Staff",
    ...
    TP_LowAcc_Priority = {
        --        Main = {'Xiutleato', 'Honor Sword'},
        --        Sub = {'R.K. Army Shield', 'Kite Shield'},
        ...
        Back = {'Earth Mantle', 'Lizard Mantle'},
...
profile.HandleAbility = function()
    ...
    if (not action.Name:contains("Jig")) then
