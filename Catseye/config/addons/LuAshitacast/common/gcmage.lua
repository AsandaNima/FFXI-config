...
local fire_staff = "Iridal Staff"
local earth_staff = "Iridal Staff"
local water_staff = "Iridal Staff"
local wind_staff = "Iridal Staff"
local ice_staff = "Iridal Staff"
local thunder_staff = "Iridal Staff"
local light_staff = "Iridal Staff"
local dark_staff = "Iridal Staff"
...
function gcmage.DoCommands(args)
    ...
    if (player.MainJob == "RDM" or player.MainJob == "WHM" or player.MainJob == "BRD" or player.MainJob == "SCH") then
...
function gcmage.DoDefault(sets, ninSJMMP, whmSJMMP, blmSJMMP, rdmSJMMP)
    local player = gData.GetPlayer()
