...
gcinclude.sets = T{
	...
	Fishing2 = { -- this set is meant as a default set for fishing, equip using /fishset2
		Range = 'Ebisu Fishing Rod',
...
gcinclude.settings = {
	...
	RegenGearHPP = 90; -- set HPP to have your idle regen set to come on
...
gcinclude.AliasList = T{'gcmessages','wsdistance','dt','th','kite','meleeset','gcdrain','gcaspir','nukeset','burst','weapon','elecycle','helix','weather','nuke','death','fight','sir','tankset','proc','cj','pupmode','tpgun','cormsg','forcestring','siphon','warpring','telering','rrset','craftset','zeniset','fishset','fishset2','mpset'};
...
function gcinclude.SetCommands(args)
	...
	elseif (args[1] == 'fishset2') then
		gcinclude.FishSet2 = not gcinclude.FishSet2;
		gcinclude.FishSet = false;
		toggle = 'Fishing Set 2';
		status = gcinclude.FishSet2;
...
function gcinclude.CheckDefault()
	...
	if (gcinclude.FishSet2 == true) then gFunc.EquipSet(gcinclude.sets.Fishing2) end
