...
settings["padding"][2] = 1;
settings["padding"][3] = 1;
settings["padding"][4] = 1;
...
settings["background"]["position_x"] = 2909;
settings["background"]["position_y"] = 601;
